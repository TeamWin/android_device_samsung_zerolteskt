...
TARGET_PREBUILT_KERNEL := device/samsung/zerolteskt/Image
TARGET_PREBUILT_DTB := device/samsung/zerolteskt/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/zerolteskt/bootimg.mk
...
TARGET_LIBINIT_DEFINES_FILE := device/samsung/zerolteskt/init/init_zerolteskt.cpp
